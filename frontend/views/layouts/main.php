                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?= Url::to(['site/rest-password'])?>"><i class="icon-cog"></i> 修改密码</a></li>
                            <li><a href="<?= Url::to(['site/logout'])?>" data-method="post" ><i class="icon-off"></i> 注销</a></li>
                        </ul>
                    </li>
                    <!-- end: User Dropdown -->
                </ul>
        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    ?>
                    <li>
                        <a href="<?= Url::to(['persons/index','id'=>$nav['post_id']])?>">
                            <i class=""></i>
                            <span class="hidden-tablet"> <?= $nav['post_name'];?></span>
                        </a>
                    </li>
                    <?php endforeach; ?>
                    <?php endif; ?>
